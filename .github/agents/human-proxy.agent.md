...
| MemPalace config | `gateway/openclaw_config/` | MemPalace MCP server configuration |
...
- `gateway/agent_config/skills/mempalace/` — MemPalace MCP tools, knowledge graph, autoresearch memory integration
