...
from gateway.research.status import build_status_frame, read_status, resolve_research_root

app = typer.Typer(help="G2 OpenClaw Gateway CLI utilities.")
app.add_typer(research_app, name="research")
console = Console()
_RESEARCH_ROOT_OPTION = typer.Option(None, "--root")


@app.command("research-status")
def research_status(
    root: Path | None = _RESEARCH_ROOT_OPTION,
) -> None:
...
_REQUIRED_OPENCLAW_VERSION = (2026, 9, 2)
_REQUIRED_OPENCLAW_VERSION_TEXT = "2026.9.2"
