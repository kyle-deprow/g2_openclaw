...
StatusState = Literal["loading", "recording", "transcribing", "thinking", "streaming", "idle"]
...
def _check_fields(data: dict[str, Any], required: list[str], frame_type: str) -> None:
    """Check required fields are present and have correct types."""
    for field in required:
        if field not in data:
            raise ProtocolError(f"Frame type '{frame_type}' missing required field '{field}'")
