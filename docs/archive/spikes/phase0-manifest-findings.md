...
The design docs ([g2-app.md](../../design/g2-app.md) §9) assumed this manifest:
...
### Doc 03 ([g2-app.md](../../design/g2-app.md)) — Required Updates
...
### Doc 05 ([architecture-review.md](../reviews/architecture-review.md)) — No Changes Needed
...
| Task | Impact |
|------|--------|
| **Task 3: App skeleton** | Use the golden manifest from §4 above, not the one in [g2-app.md](../../design/g2-app.md). |
