...
├── gateway/
│   ├── server.py                      ← PC Gateway WebSocket server (Python)
│   ├── transcriber.py                 ← Whisper integration (faster-whisper)
│   ├── openclaw_client.py             ← OpenClaw WebSocket client
│   ├── pyproject.toml                 ← Python dependencies (websockets, faster-whisper)
│   └── README.md
├── whisper_stt/
│   ├── server.py                      ← Standalone Whisper STT server (legacy / testing)
│   ├── pyproject.toml
│   └── README.md
├── openclaw_config/                   ← OpenClaw configuration
├── openclaw_research/                 ← Research notes on OpenClaw internals
│   ├── 01_overview_and_installation.md
│   ├── 02_agent_architecture_and_context.md
│   ├── ...
│   └── 08_configuration_reference.md
└── .github/
